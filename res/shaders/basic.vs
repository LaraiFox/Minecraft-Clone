...
void main() {
	v_Color = vec4(color * vec3(dot(normalAttrib, -lightDirection) / 2.0 + 0.5), 1.0);

	// if (normalAttrib.x == -1.0) {
		// v_Color = vec4(color * vec3(0.8), 1.0);
	// } else if (normalAttrib.x == 1.0) {
		// v_Color = vec4(color * vec3(0.7), 1.0);
	// } else if (normalAttrib.y == -1.0) {
		// v_Color = vec4(color * vec3(0.5), 1.0);
	// } else if (normalAttrib.y == 1.0) {
		// v_Color = vec4(color, 1.0);
	// } else if (normalAttrib.z == -1.0) {
		// v_Color = vec4(color * vec3(0.9), 1.0);
	// } else if (normalAttrib.z == 1.0) {
		// v_Color = vec4(color * vec3(0.6), 1.0);
	// }
